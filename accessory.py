...
class Lock(Accessory):
    ...
    def __init__(self, *args, service: Service, fingerprintReader, **kwargs):
        ...
        sleep(0.5)
        self._lock_target_state = 1 if self.lock.closed and (not self.lock.top_mosfet.is_active) else 0
